...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header text-center" style=" font-size: 32px;">Register Pasien</div>
                <div class="card-body">
                    <form method="POST" action="index.php?page=registerPasien">
                        ...
                        <br>
                        <div class="form-group">
                            <input type="text" name="alamat" class="form-control" required placeholder="Alamat Anda">
                        </div>
                        <br>
                        <div class="form-group">
                    ...
                    <div class="text-center">
                        <p class="mt-3">Sudah Mempunyai Akun? <a href="index.php?page=loginPasien">Login</a></p>
                    </div>
                </div>
            </div>
        </div>
