...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #053162;">
    ...
    <a href="index3.html" class="brand-link">
      <img src="dist/img/AdminLTELogo2.png" alt="UDNS" class="brand-image img-circle elevation-3" style="opacity: .8">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2023-2024 <a href="https://dinus.ac.i">UDINUS</a>.</strong>
    All rights reserved.
