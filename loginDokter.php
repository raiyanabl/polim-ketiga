...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header text-center" style="font-size: 32px;">Login Dokter</div>
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <p class="mt-3">Belum mempunyai akun? <a href="index.php?page=registerDokter">Register</a></p>
                    </div>
                </div>
            </div>
        </div>
